...
import { FsrComponent } from './fsr/fsr.component';
import { FqeComponent } from './fqe/fqe.component';
import { FruComponent } from './fru/fru.component';
...
const routes: Routes = [
  {
    ...
    data:{
      ...
      {
  path:'fru',
  component:FruComponent,
  data:{
    Title:"Financial Resources and their Utilisation"
  }
